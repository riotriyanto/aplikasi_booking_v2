...
public class Session {
    ...
    static final String KEY_ID_TEREGISTER ="user";
    ...
    public static void setRegisteredId(Context context, String id){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_ID_TEREGISTER, id);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_USER_TEREGISTER berupa String */
    public static String getRegisteredId(Context context){
        return getSharedPreference(context).getString(KEY_ID_TEREGISTER,"");
    }
